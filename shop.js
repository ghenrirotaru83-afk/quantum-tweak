...
//        const status = data.detectionStatus || 'undetected';
...
//            if (status === 'detected') {
//                text.textContent = 'Detected — ' + dateStr;
//                dot.style.background = '#ef4444';
//                dot.style.boxShadow = '0 0 8px #ef4444';
//                badge.style.borderColor = 'rgba(239,68,68,0.2)';
//                badge.style.background = 'rgba(239,68,68,0.06)';
//            } else if (status === 'updating') {
//                text.textContent = 'Updating — ' + dateStr;
//                dot.style.background = '#eab308';
//                dot.style.boxShadow = '0 0 8px #eab308';
//                badge.style.borderColor = 'rgba(234,179,8,0.2)';
//                badge.style.background = 'rgba(234,179,8,0.06)';
//            } else {
//                text.textContent = 'Undetected — Updated ' + dateStr;
//            }
//        }
//        // Active users count
//        if (data.activeUsers) {
